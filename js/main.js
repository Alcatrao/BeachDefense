...
function loadGhostModel(callback) {
  ...
  loader.load('Halloween Ghost.fbx', (fbx) => {
    ...
    const baseColor = texLoader.load('./assets/Ghost/Textures/Ghost_BaseColor.png');
    const normalMap = texLoader.load('./assets/Ghost/Textures/Ghost_Normal.png');
    const roughnessMap = texLoader.load('./assets/Ghost/Textures/Ghost_Roughness.png');
    const aoMap = texLoader.load('./assets/Ghost/Textures/Ghost_Emissive.png');
    fbx.traverse(child => {
      if (child.isMesh) {
